...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <div class="container">
           ...
           <p class="mt-5 mb-3 text-muted">Sudah punya akun? <a href="Login">Login Disini!</a></p>
    ...
    <footer class="footer mt-auto py-3 bg-light">
        <div class="container">
            <span class="text-muted">Somad - Social Media Agent</span>
        </div>
    </footer>
